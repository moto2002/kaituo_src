...
{
	public class TaskTemplate_7 : TaskTemplateArg
	{
		...
		public List<ChangeNpcElement> StoryOverChangeElement = new List<ChangeNpcElement>();
		...
		public List<ChangeSceneNpc> StoryOverChangeSceneNpc = new List<ChangeSceneNpc>();
		...
		public List<ChangeSceneElement> StoryOverChangeSceneElement = new List<ChangeSceneElement>();
