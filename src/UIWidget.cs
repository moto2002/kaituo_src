...
public class UIWidget : UIRect
{
	...
	public delegate void OnDrawCallChange(UIDrawCall dc);
	...
	public UIWidget.OnDrawCallChange onDrawCallChange;
	...
	public UIDrawCall drawCall
	{
		...
		{
			this._dc = value;
			if (this.onDrawCallChange != null)
			{
				this.onDrawCallChange(value);
			}
		}
	}
	...
	public virtual Vector3[] worldBounds
	{
		get
		{
