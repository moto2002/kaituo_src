...
public class LuaInterface_DebuggerWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("Log", new LuaCSFunction(LuaInterface_DebuggerWrap.Log));
		L.RegFunction("LogWarning", new LuaCSFunction(LuaInterface_DebuggerWrap.LogWarning));
		L.RegFunction("LogError", new LuaCSFunction(LuaInterface_DebuggerWrap.LogError));
		L.RegFunction("LogException", new LuaCSFunction(LuaInterface_DebuggerWrap.LogException));
		L.RegVar("useLog", new LuaCSFunction(LuaInterface_DebuggerWrap.get_useLog), new LuaCSFunction(LuaInterface_DebuggerWrap.set_useLog));
		L.RegVar("threadStack", new LuaCSFunction(LuaInterface_DebuggerWrap.get_threadStack), new LuaCSFunction(LuaInterface_DebuggerWrap.set_threadStack));
		L.RegVar("logger", new LuaCSFunction(LuaInterface_DebuggerWrap.get_logger), new LuaCSFunction(LuaInterface_DebuggerWrap.set_logger));
		L.EndStaticLibs();
	}
	...
	private static int Log(IntPtr L)
	{
		...
		try
		{
			...
			{
				result = LuaDLL.luaL_throw(L, "invalid arguments to method: LuaInterface.Debugger.Log");
			}
		}
		catch (Exception e)
		{
	...
	private static int LogWarning(IntPtr L)
	{
		...
		try
		{
			...
			{
				result = LuaDLL.luaL_throw(L, "invalid arguments to method: LuaInterface.Debugger.LogWarning");
			}
		}
		catch (Exception e)
		{
	...
	private static int LogError(IntPtr L)
	{
		...
		try
		{
			...
			{
				result = LuaDLL.luaL_throw(L, "invalid arguments to method: LuaInterface.Debugger.LogError");
			}
		}
		catch (Exception e)
		{
	...
	private static int LogException(IntPtr L)
	{
		...
		try
		{
			...
			{
				result = LuaDLL.luaL_throw(L, "invalid arguments to method: LuaInterface.Debugger.LogException");
			}
		}
		catch (Exception e3)
		{
