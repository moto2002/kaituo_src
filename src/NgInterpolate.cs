...
public class NgInterpolate
{
	...
	{
		NgInterpolate.<NewTimer>c__Iterator10 <NewTimer>c__Iterator = new NgInterpolate.<NewTimer>c__Iterator10();
		<NewTimer>c__Iterator.duration = duration;
		<NewTimer>c__Iterator.<$>duration = duration;
		NgInterpolate.<NewTimer>c__Iterator10 expr_15 = <NewTimer>c__Iterator;
		expr_15.$PC = -2;
		return expr_15;
	}
	...
	{
		NgInterpolate.<NewCounter>c__Iterator11 <NewCounter>c__Iterator = new NgInterpolate.<NewCounter>c__Iterator11();
		...
		<NewCounter>c__Iterator.<$>end = end;
		<NewCounter>c__Iterator.<$>step = step;
		NgInterpolate.<NewCounter>c__Iterator11 expr_31 = <NewCounter>c__Iterator;
		expr_31.$PC = -2;
		return expr_31;
	}
	...
	{
		NgInterpolate.<NewEase>c__Iterator12 <NewEase>c__Iterator = new NgInterpolate.<NewEase>c__Iterator12();
	...
	{
		NgInterpolate.<NewBezier>c__Iterator13<T> <NewBezier>c__Iterator = new NgInterpolate.<NewBezier>c__Iterator13<T>();
		...
		<NewBezier>c__Iterator.<$>ease = ease;
		<NewBezier>c__Iterator.<$>maxStep = maxStep;
		NgInterpolate.<NewBezier>c__Iterator13<T> expr_4F = <NewBezier>c__Iterator;
		expr_4F.$PC = -2;
		return expr_4F;
	}
	...
	{
		NgInterpolate.<NewCatmullRom>c__Iterator14<T> <NewCatmullRom>c__Iterator = new NgInterpolate.<NewCatmullRom>c__Iterator14<T>();
		...
		<NewCatmullRom>c__Iterator.<$>loop = loop;
		<NewCatmullRom>c__Iterator.<$>slices = slices;
		NgInterpolate.<NewCatmullRom>c__Iterator14<T> expr_3F = <NewCatmullRom>c__Iterator;
		expr_3F.$PC = -2;
		return expr_3F;
	}
