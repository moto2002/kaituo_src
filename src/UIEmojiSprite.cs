...
[ExecuteInEditMode]
public class UIEmojiSprite : UIBasicSprite
{
	...
	public override void OnFill(BetterList<Vector3> verts, BetterList<Vector2> uvs, BetterList<Color> cols)
	{
		...
		base.outerUV = NGUIMath.ConvertToTexCoords(rect, mainTexture.width, mainTexture.height);
		base.innerUV = NGUIMath.ConvertToTexCoords(rect2, mainTexture.width, mainTexture.height);
		int size = verts.size;
	...
	private void SimpleFill(BetterList<Vector3> verts, BetterList<Vector2> uvs, BetterList<Color> cols)
	{
		...
		Color drawingColor = base.drawingColor;
		Color item = drawingColor.GammaToLinearSpace();
		verts.Add(new Vector3(drawingDimensions.x + this.Verts.x, drawingDimensions.y + this.Verts.y));
		verts.Add(new Vector3(drawingDimensions.x + this.Verts.x, drawingDimensions.w + this.Verts.y));
		verts.Add(new Vector3(drawingDimensions.z + this.Verts.x, drawingDimensions.w + this.Verts.y));
		verts.Add(new Vector3(drawingDimensions.z + this.Verts.x, drawingDimensions.y + this.Verts.y));
