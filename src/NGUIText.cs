...
public static class NGUIText
{
	...
	public static Color mInvisible = new Color(0f, 0f, 0f, 0f);
	...
	public static float[] mBoldOffset = new float[]
	{
		-0.25f,
		0f,
		0.25f,
	...
	public static bool ParseSymbol(string text, ref int index, BetterList<Color> colors, bool premultiply, ref int sub, ref bool bold, ref bool italic, ref bool underline, ref bool strike, ref bool ignoreColor)
	{
		...
		if (text[index + 4] == ']')
		{
			...
			if (text3 != null)
			{
				...
				{
					NGUIText.<>f__switch$map3 = new Dictionary<string, int>(2)
					{
						{
							"[sub]",
							0
				...
				int num;
				if (NGUIText.<>f__switch$map3.TryGetValue(text3, out num))
				{
					if (num == 0)
					{
						sub = 1;
			...
			else
			{
				...
				else
				{
					...
					if (glyphInfo != null)
					{
						...
						if (num8 != 0)
						{
							NGUIText.GlyphInfo expr_517_cp_0 = glyphInfo;
							expr_517_cp_0.v0.x = expr_517_cp_0.v0.x * 0.75f;
							NGUIText.GlyphInfo expr_52F_cp_0 = glyphInfo;
							expr_52F_cp_0.v0.y = expr_52F_cp_0.v0.y * 0.75f;
							NGUIText.GlyphInfo expr_547_cp_0 = glyphInfo;
							expr_547_cp_0.v1.x = expr_547_cp_0.v1.x * 0.75f;
							NGUIText.GlyphInfo expr_55F_cp_0 = glyphInfo;
							expr_55F_cp_0.v1.y = expr_55F_cp_0.v1.y * 0.75f;
							if (num8 == 1)
							{
								NGUIText.GlyphInfo expr_57F_cp_0 = glyphInfo;
								expr_57F_cp_0.v0.y = expr_57F_cp_0.v0.y - NGUIText.fontScale * (float)NGUIText.fontSize * 0.4f;
								NGUIText.GlyphInfo expr_5A4_cp_0 = glyphInfo;
								expr_5A4_cp_0.v1.y = expr_5A4_cp_0.v1.y - NGUIText.fontScale * (float)NGUIText.fontSize * 0.4f;
							}
							else
							{
								NGUIText.GlyphInfo expr_5CE_cp_0 = glyphInfo;
								expr_5CE_cp_0.v0.y = expr_5CE_cp_0.v0.y + NGUIText.fontScale * (float)NGUIText.fontSize * 0.05f;
								NGUIText.GlyphInfo expr_5F3_cp_0 = glyphInfo;
								expr_5F3_cp_0.v1.y = expr_5F3_cp_0.v1.y + NGUIText.fontScale * (float)NGUIText.fontSize * 0.05f;
							}
						}
