...
public class iTween : MonoBehaviour
{
	...
	{
		iTween[] components = root.GetComponents<iTween>();
	...
	public static Func<float, float, float, float> GetEaseFunction(iTween.EaseType easeType)
	{
		switch (easeType)
		{
		case iTween.EaseType.easeInQuad:
			return new Func<float, float, float, float>(iTween.Tween.easeInQuad);
		case iTween.EaseType.easeOutQuad:
			return new Func<float, float, float, float>(iTween.Tween.easeOutQuad);
		case iTween.EaseType.easeInOutQuad:
			return new Func<float, float, float, float>(iTween.Tween.easeInOutQuad);
		case iTween.EaseType.easeInCubic:
			return new Func<float, float, float, float>(iTween.Tween.easeInCubic);
		case iTween.EaseType.easeOutCubic:
			return new Func<float, float, float, float>(iTween.Tween.easeOutCubic);
		case iTween.EaseType.easeInOutCubic:
			return new Func<float, float, float, float>(iTween.Tween.easeInOutCubic);
		case iTween.EaseType.easeInQuart:
			return new Func<float, float, float, float>(iTween.Tween.easeInQuart);
		case iTween.EaseType.easeOutQuart:
			return new Func<float, float, float, float>(iTween.Tween.easeOutQuart);
		case iTween.EaseType.easeInOutQuart:
			return new Func<float, float, float, float>(iTween.Tween.easeInOutQuart);
		case iTween.EaseType.easeInQuint:
			return new Func<float, float, float, float>(iTween.Tween.easeInQuint);
		case iTween.EaseType.easeOutQuint:
			return new Func<float, float, float, float>(iTween.Tween.easeOutQuint);
		case iTween.EaseType.easeInOutQuint:
			return new Func<float, float, float, float>(iTween.Tween.easeInOutQuint);
		case iTween.EaseType.easeInSine:
			return new Func<float, float, float, float>(iTween.Tween.easeInSine);
		case iTween.EaseType.easeOutSine:
			return new Func<float, float, float, float>(iTween.Tween.easeOutSine);
		case iTween.EaseType.easeInOutSine:
			return new Func<float, float, float, float>(iTween.Tween.easeInOutSine);
		case iTween.EaseType.easeInExpo:
			return new Func<float, float, float, float>(iTween.Tween.easeInExpo);
		case iTween.EaseType.easeOutExpo:
			return new Func<float, float, float, float>(iTween.Tween.easeOutExpo);
		case iTween.EaseType.easeInOutExpo:
			return new Func<float, float, float, float>(iTween.Tween.easeInOutExpo);
		case iTween.EaseType.easeInCirc:
			return new Func<float, float, float, float>(iTween.Tween.easeInCirc);
		case iTween.EaseType.easeOutCirc:
			return new Func<float, float, float, float>(iTween.Tween.easeOutCirc);
		case iTween.EaseType.easeInOutCirc:
			return new Func<float, float, float, float>(iTween.Tween.easeInOutCirc);
		case iTween.EaseType.linear:
			return new Func<float, float, float, float>(iTween.Tween.linear);
		case iTween.EaseType.spring:
			return new Func<float, float, float, float>(iTween.Tween.spring);
		case iTween.EaseType.easeInBounce:
			return new Func<float, float, float, float>(iTween.Tween.easeInBounce);
		case iTween.EaseType.easeOutBounce:
			return new Func<float, float, float, float>(iTween.Tween.easeOutBounce);
		case iTween.EaseType.easeInOutBounce:
			return new Func<float, float, float, float>(iTween.Tween.easeInOutBounce);
		case iTween.EaseType.easeInBack:
			return new Func<float, float, float, float>(iTween.Tween.easeInBack);
		case iTween.EaseType.easeOutBack:
			return new Func<float, float, float, float>(iTween.Tween.easeOutBack);
		case iTween.EaseType.easeInOutBack:
			return new Func<float, float, float, float>(iTween.Tween.easeInOutBack);
		case iTween.EaseType.easeInElastic:
			return new Func<float, float, float, float>(iTween.Tween.easeInElastic);
		case iTween.EaseType.easeOutElastic:
			return new Func<float, float, float, float>(iTween.Tween.easeOutElastic);
		case iTween.EaseType.easeInOutElastic:
			return new Func<float, float, float, float>(iTween.Tween.easeInOutElastic);
		default:
			return new Func<float, float, float, float>(iTween.Tween.linear);
		}
	}
	...
	private void GenerateTargets()
	{
		...
		case "move":
		{
			...
			if (text2 != null)
			{
				...
				{
					iTween.<>f__switch$mapD = new Dictionary<string, int>(3)
					{
						{
							"to",
							0
	...
	{
		iTween.<TweenDelay>c__Iterator2F <TweenDelay>c__Iterator2F = new iTween.<TweenDelay>c__Iterator2F();
		<TweenDelay>c__Iterator2F.<>f__this = this;
		return <TweenDelay>c__Iterator2F;
	}
	...
	{
		iTween.<TweenRestart>c__Iterator30 <TweenRestart>c__Iterator = new iTween.<TweenRestart>c__Iterator30();
	...
	{
		iTween.<Start>c__Iterator31 <Start>c__Iterator = new iTween.<Start>c__Iterator31();
