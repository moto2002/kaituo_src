...
public class NcTilingTexture : NcEffectBehaviour
{
	...
	private void Start()
	{
		...
		{
			base.GetComponent<Renderer>().material.mainTextureScale = new Vector2(this.m_fTilingX, this.m_fTilingY);
			base.GetComponent<Renderer>().material.mainTextureOffset = new Vector2(this.m_fOffsetX - (float)((int)this.m_fOffsetX), this.m_fOffsetY - (float)((int)this.m_fOffsetY));
			base.AddRuntimeMaterial(base.GetComponent<Renderer>().material);
		}
	}
