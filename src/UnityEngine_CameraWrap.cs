...
public class UnityEngine_CameraWrap
{
	...
	private static int SetStereoViewMatrices(IntPtr L)
	{
		...
		try
		{
			...
			Camera camera = (Camera)ToLua.CheckObject(L, 1, typeof(Camera));
			Matrix4x4 leftMatrix = (Matrix4x4)ToLua.CheckObject(L, 2, typeof(Matrix4x4));
			Matrix4x4 rightMatrix = (Matrix4x4)ToLua.CheckObject(L, 3, typeof(Matrix4x4));
			camera.SetStereoViewMatrices(leftMatrix, rightMatrix);
			result = 0;
		}
		catch (Exception e)
		{
	...
	private static int SetStereoProjectionMatrices(IntPtr L)
	{
		...
		try
		{
			...
			Matrix4x4 leftMatrix = (Matrix4x4)ToLua.CheckObject(L, 2, typeof(Matrix4x4));
			Matrix4x4 rightMatrix = (Matrix4x4)ToLua.CheckObject(L, 3, typeof(Matrix4x4));
			camera.SetStereoProjectionMatrices(leftMatrix, rightMatrix);
			result = 0;
		}
		catch (Exception e)
		{
	...
	private static int AddCommandBuffer(IntPtr L)
	{
		...
		try
		{
			ToLua.CheckArgsCount(L, 3);
			Camera camera = (Camera)ToLua.CheckObject(L, 1, typeof(Camera));
			CameraEvent evt = (CameraEvent)LuaDLL.luaL_checknumber(L, 2);
	...
	private static int set_renderingPath(IntPtr L)
	{
		...
		try
		{
			obj = ToLua.ToObject(L, 1);
			Camera camera = (Camera)obj;
			RenderingPath renderingPath = (RenderingPath)LuaDLL.luaL_checknumber(L, 2);
	...
	private static int set_opaqueSortMode(IntPtr L)
	{
		...
		try
		{
			obj = ToLua.ToObject(L, 1);
			Camera camera = (Camera)obj;
			OpaqueSortMode opaqueSortMode = (OpaqueSortMode)LuaDLL.luaL_checknumber(L, 2);
	...
	private static int set_transparencySortMode(IntPtr L)
	{
		...
		try
		{
			obj = ToLua.ToObject(L, 1);
			Camera camera = (Camera)obj;
			TransparencySortMode transparencySortMode = (TransparencySortMode)LuaDLL.luaL_checknumber(L, 2);
	...
	private static int set_cameraType(IntPtr L)
	{
		...
		try
		{
			obj = ToLua.ToObject(L, 1);
			Camera camera = (Camera)obj;
			CameraType cameraType = (CameraType)LuaDLL.luaL_checknumber(L, 2);
	...
	private static int set_depthTextureMode(IntPtr L)
	{
		...
		try
		{
			obj = ToLua.ToObject(L, 1);
			Camera camera = (Camera)obj;
			DepthTextureMode depthTextureMode = (DepthTextureMode)LuaDLL.luaL_checknumber(L, 2);
