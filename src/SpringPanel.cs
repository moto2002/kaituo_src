...
public class SpringPanel : MonoBehaviour
{
	...
	protected virtual void AdvanceTowardsPosition()
	{
		...
		this.AdvanceTowardsPosition(deltaTime);
	}

	public void AdvanceTowardsPosition(float delta)
	{
		if (this.mTrans == null)
		{
			this.mPanel = base.GetComponent<UIPanel>();
		...
		Vector3 vector = NGUIMath.SpringLerp(this.mTrans.localPosition, this.target, this.strength, delta);
