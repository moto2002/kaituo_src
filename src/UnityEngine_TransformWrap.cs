...
public class UnityEngine_TransformWrap
{
	...
	private static int Translate(IntPtr L)
	{
		...
		try
		{
			...
			else if (num == 3 && TypeChecker.CheckTypes(L, 1, typeof(Transform), typeof(Vector3), typeof(uint)))
			{
				Transform transform3 = (Transform)ToLua.ToObject(L, 1);
				Vector3 translation3 = ToLua.ToVector3(L, 2);
				Space relativeTo2 = (Space)LuaDLL.lua_tonumber(L, 3);
			...
			else if (num == 5 && TypeChecker.CheckTypes(L, 1, typeof(Transform), typeof(float), typeof(float), typeof(float), typeof(uint)))
			{
				...
				Space relativeTo4 = (Space)LuaDLL.lua_tonumber(L, 5);
	...
	private static int Rotate(IntPtr L)
	{
		...
		try
		{
			...
			else if (num == 3 && TypeChecker.CheckTypes(L, 1, typeof(Transform), typeof(Vector3), typeof(uint)))
			{
				...
				Space relativeTo = (Space)LuaDLL.lua_tonumber(L, 3);
				transform3.Rotate(eulerAngles2, relativeTo);
				result = 0;
			}
			else if (num == 4 && TypeChecker.CheckTypes(L, 1, typeof(Transform), typeof(Vector3), typeof(float), typeof(uint)))
			{
				Transform transform4 = (Transform)ToLua.ToObject(L, 1);
				Vector3 axis2 = ToLua.ToVector3(L, 2);
				float angle2 = (float)LuaDLL.lua_tonumber(L, 3);
				Space relativeTo2 = (Space)LuaDLL.lua_tonumber(L, 4);
			...
			else if (num == 5 && TypeChecker.CheckTypes(L, 1, typeof(Transform), typeof(float), typeof(float), typeof(float), typeof(uint)))
			{
				...
				Space relativeTo3 = (Space)LuaDLL.lua_tonumber(L, 5);
