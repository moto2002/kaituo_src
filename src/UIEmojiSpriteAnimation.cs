...
[ExecuteInEditMode, RequireComponent(typeof(UIEmojiSprite))]
public class UIEmojiSpriteAnimation : MonoBehaviour
{
	...
	protected UIEmojiSprite mSprite;
	...
	public void RebuildSpriteList()
	{
		...
		{
			this.mSprite = base.GetComponent<UIEmojiSprite>();
		}
		...
		if (this.mSprite != null && this.mSprite.atlas != null)
		{
			...
			this.mFPS = this.mSpriteNames.Count;
		}
	}
